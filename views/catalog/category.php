                            ...
                            <div class="panel-group category-products">
                                ...
                                <div class="panel panel-default ">
                                    <div class="panel-heading ">
                                        <h4 class="panel-title"><a <?php if($idCategory[0]==$categoryItem['id']) echo "class='active'"; ?> href="/category/<?php echo $categoryItem['id']; ?>">
