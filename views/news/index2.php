...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <!-- 
	...
	<div id="fh5co-offcanvas">
		...
		<div class="fh5co-bio">
			<figure>
				<img src="/template/images/person1.jpg" alt="Free HTML5 Bootstrap Template" class="img-responsive">
			</figure>
	...
	<div class="container-fluid">
		<div class="row fh5co-post-entry">
			<?php foreach($newsList as $newsItem): ?><!--ID, TITLE, DATE, SHORT_CONTENT-->
				<article class="col-lg-3 col-md-3 col-sm-3 col-xs-6 col-xxs-12 animate-box">
				<figure>
					<a href="/news/<?php echo $newsItem['ID']; ?>"><img src="<?php echo '/template/images/'.$newsItem['IMAGEURI']; ?>" alt="Image" class="img-responsive"></a>
				</figure>
				<span class="fh5co-meta"><a href="/views/news/single.html">Спорт &amp; Новости</a></span>
				<h2 class="fh5co-article-title"><a href="/news/<?php echo $newsItem['ID']; ?>"><?php echo $newsItem['TITLE']; ?></a></h2>
				<span class="fh5co-meta fh5co-date"><?php echo $newsItem['DATE']; ?></span>
			</article>
			<?php endforeach;?>	
			<article class="col-lg-3 col-md-3 col-sm-3 col-xs-6 col-xxs-12 animate-box">
				<figure>
					<a href="single.html"><img src="/template/images/pic_1.jpg" alt="Image" class="img-responsive"></a>
				</figure>
			...
			<article class="col-lg-3 col-md-3 col-sm-3 col-xs-6 col-xxs-12 animate-box">
				<figure>
					<a href="single.html"><img src="/template/images/pic_2.jpg" alt="Image" class="img-responsive"></a>
				</figure>
				<span class="fh5co-meta"><a href="single.html">Food &amp; Drink</a></span>
			...
			<article class="col-lg-3 col-md-3 col-sm-3 col-xs-6 col-xxs-12 animate-box">
				<figure>
					<a href="single.html"><img src="/template/images/pic_3.jpg" alt="Image" class="img-responsive"></a>
				</figure>
			...
			<article class="col-lg-3 col-md-3 col-sm-3 col-xs-6 col-xxs-12 animate-box">
				<figure>
					<a href="single.html"><img src="/template/images/pic_4.jpg" alt="Image" class="img-responsive"></a>
				</figure>
				<span class="fh5co-meta"><a href="single.html">Travel</a>, <a href="single.html">Style</a></span>
			...
			<article class="col-lg-3 col-md-3 col-sm-3 col-xs-6 col-xxs-12 animate-box">
				<figure>
					<a href="single.html"><img src="/template/images/pic_5.jpg" alt="Image" class="img-responsive"></a>
				</figure>
